	 ...
	 $(document).ready(function(){
      ...
      check_sname();
	   ...
	   function check_fname(){
		var pattern = /^[a-zA-Z]*$/;
		var fname = $('#form_fanme').val();

		if(pattern.test(fname) && fname !==''){
			$('#error_fname_message').hide();
			$('$form_fname').css('border-bottom', '2px solid green');
		}else{
			$('#fname_error_message').html('only character');
			$('#fname_error_message').show();
			$('#form_fname').css('border-botttom', '2px solid red');
			error_fname = true;
		}
	   }
	   //check sname
	   function check_sname(){
		var pattern = /^[a-zA-Z]*$/;
		var sname = $('#form_sanme').val();

		if(pattern.test(sname) && sname !==''){
			$('#sname_error_message').hide();
			$('$form_sname').css('border-bottom', '2px solid green');
		}else{
			$('#sname_error_message').html('only character');
			$('#sname_error_message').show();
			$('#form_sname').css('border-botttom', '2px solid red');
			error_sname = true;
		}
	   }
	   //check password
